...
// Idéntico a /admin/invitacion/page.tsx (mismo flujo de Supabase: token en
// el fragmento de la URL, setSession, updateUser) — solo cambia el destino
// final (/cliente en vez de /admin). Ver la nota grande en esa página para
// el detalle de por qué esto corre entero del lado del navegador.
type Estado = "verificando" | "listo" | "invalido" | "guardando";
type Errores = Partial<Record<"password" | "confirmar", string>>;

export default function PaginaInvitacionCliente() {
