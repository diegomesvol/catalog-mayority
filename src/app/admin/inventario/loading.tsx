...
// Reproduce la forma real de InventarioAdmin (4 tarjetas KPI + barra de
// filtros + tabla) para cubrir la espera de leerCatalogoParaInventario() sin
// pantalla en blanco — mismo criterio que el resto de los loading.tsx.
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-6 sm:px-6 sm:py-8" aria-label="Cargando" role="status">
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="flex flex-col gap-2 rounded-xl border border-ink-200 p-4">
